...
- (instancetype) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_sendBtn setImage:[UIImage imageNamed:@"notselect"] forState:UIControlStateNormal];
        [_sendBtn setImage:[UIImage imageNamed:@"select"] forState:UIControlStateSelected];
...
- (void)clickBtn:(UIButton *)btn
{
    ...
    if (_Clickblock) {
        _Clickblock(_model,btn.isSelected);
    }
}
- (void)layoutSubviews
{
