...
//            NSInteger type = [responseObject[@"errorCode"] integerValue];
//            NSString *reason = [CJErrorHelper reportErrorMessage:type];
//            if (reason && failure) {
//                NSError *error = [NSError errorWithDomain:NSURLErrorDomain code:type userInfo:@{@"reason": reason}];
//                failure(error);
//            }
//            return;
//        }
...
//        if (failure) {
//            NSError *networkError = [NSError errorWithDomain:error.domain code:error.code userInfo:@{@"reason": LOCALIZATION(@"网络不稳定，请检查网络")}];
...
//        
//        for (CJFormData *formData in formDataArray) {
...
//            NSString *reason = [CJErrorHelper reportErrorMessage:errorCode];
//            NSError *error = [NSError errorWithDomain:NSURLErrorDomain code:errorCode userInfo:@{@"reason:%@": reason}];
//            failure(error);
//            return;
//        }
//        
