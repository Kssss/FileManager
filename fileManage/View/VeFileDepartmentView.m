...
- (UIView *)indicatorView {
    if (!_indicatorView) {
        ...
        _indicatorView.backgroundColor = color01a;
    }
...
- (void)initializeSubviews {
    ...
    for (int i = 0; i < self.departmentArr.count; ++i) {
        ...
        [partBtn setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
        [partBtn setTitleColor:[UIColor grayColor]  forState:UIControlStateSelected];
